############################################################################################################ DR
######################################## Process TB
tab_TB_dr = multiplex_plot_d(fit_TB_F, HPDI=0.9, export_as_table = TRUE, plot = FALSE, mode="cor")
...
######################################## Process SU
tab_SU_dr = multiplex_plot_d(fit_SU_F, HPDI=0.9, export_as_table = TRUE, plot = FALSE, mode="cor")
...
######################################## Process SC
tab_SC_dr = multiplex_plot_d(fit_SC_F, HPDI=0.9, export_as_table = TRUE, plot = FALSE, mode="cor")
...
######################################## Process BS
tab_BS_dr = multiplex_plot_d(fit_BS_F, HPDI=0.9, export_as_table = TRUE, plot = FALSE, mode="cor")
