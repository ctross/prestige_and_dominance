############################################################################################################ DR
######################################## Process TB
tab_TB_dr = multiplex_plot_d(fit_TB_F, HPDI=0.9, export_as_table = TRUE, plot = FALSE, mode="adj")
...
######################################## Process SU
tab_SU_dr = multiplex_plot_d(fit_SU_F, HPDI=0.9, export_as_table = TRUE, plot = FALSE, mode="adj")
...
######################################## Process SC
tab_SC_dr = multiplex_plot_d(fit_SC_F, HPDI=0.9, export_as_table = TRUE, plot = FALSE, mode="adj")
...
######################################## Process BS
tab_BS_dr = multiplex_plot_d(fit_BS_F, HPDI=0.9, export_as_table = TRUE, plot = FALSE, mode="adj")
...
############################################################################################################ GR
######################################## Process TB
tab_TB_gr = multiplex_plot_g(fit_TB_F, HPDI=0.9, export_as_table = TRUE, plot = FALSE)
...
######################################## Process SU
tab_SU_gr = multiplex_plot_g(fit_SU_F, HPDI=0.9, export_as_table = TRUE, plot = FALSE)
...
######################################## Process SC
tab_SC_gr = multiplex_plot_g(fit_SC_F, HPDI=0.9, export_as_table = TRUE, plot = FALSE)
...
######################################## Process BS
tab_BS_gr = multiplex_plot_g(fit_BS_F, HPDI=0.9, export_as_table = TRUE, plot = FALSE)
...
ggsave("dr_all_sites_F.pdf", c1, width=8, height=6)
ggsave("gr_all_sites_F.pdf", c2, width=8, height=6)
